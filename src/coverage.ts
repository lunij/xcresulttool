...
// To parse this data:
//
//   import { Convert, CodeCoverage } from "./file";
//
//   const codeCoverage = Convert.toCodeCoverage(json);
//
...
export class Convert {
  public static toCodeCoverage(json: string): CodeCoverage {
    return cast(JSON.parse(json), r('CodeCoverage'))
  }

  public static codeCoverageToJson(value: CodeCoverage): string {
